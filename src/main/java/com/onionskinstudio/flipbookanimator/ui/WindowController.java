...
import com.onionskinstudio.flipbookanimator.model.Flipbook;
import com.onionskinstudio.flipbookanimator.model.SQLite;
import com.onionskinstudio.flipbookanimator.model.Thumbnail;
import com.onionskinstudio.flipbookanimator.model.Thumbnails;
...
public class WindowController {
    ...
    public void animate() {
        ...
        if(!isAnimating) {
            ...
            playBtnIcon.setImage(new Image(Studio.class.getResourceAsStream("icons/baseline_pause_black_24dp.png")));

            flipbook.setOnionSkinning(false);
            timeline.setOnFinished(e -> {
                isAnimating = false;
                flipbook.setOnionSkinning(onionSkinningOn);
                playBtnIcon.setImage(new Image(Studio.class.getResourceAsStream("icons/baseline_play_arrow_black_24dp.png")));
            });
    ...
    protected void setPencil() {
        ...
        flipbookPane.setCursor(new ImageCursor(new Image(Studio.class.getResourceAsStream("icons/pen-solid.png")), 0, 64));
    }
    @FXML
